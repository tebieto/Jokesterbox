...
if (isset($_GET['lid']) OR isset($_GET['llid']) AND (isset($_GET['pid']) AND $_GET['pid'] > 0) AND (isset($_GET['ssk'])) AND (isset($_GET['ss']) AND $_GET['ss'] > 0)) {
	if (isset ($_GET['lid'])) {
		$lid = $_GET['lid'];
...
echo "<b>People who liked this <a href=\"story.php?sk=$ssk&story=$s\">$pidname's video.</a></b>";
	} else {
echo "<b>People who laughed after viewing this <a href=\"story.php?sk=$ssk&story=$s\">$pidname's video.</a></b>";
	}	
}
 $r = mysqli_query ($dbc, $q) or
